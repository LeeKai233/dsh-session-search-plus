/**
 * `workspace` namespace dictionaries (paradigm copy layer): the official
 * workspace-browser dicts moved here verbatim from the rc.6 fork, plus the
 * search-plus additions. zh is the key-set source of truth; en is checked
 * complete against it.
 */

/** Simplified Chinese: the official workspace dict (fork baseline, byte-preserved). */
export const zh = {
  'group.ungrouped': '未分组',
  'session.new': '新会话',
...
/** English: the official workspace dict (fork baseline, byte-preserved). */
export const en = {
